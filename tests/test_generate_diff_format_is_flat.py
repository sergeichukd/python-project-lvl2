...
def expected_before_after_diff_file_flat():
    expected_file = os.path.join(TEST_DIR_PATH, "fixtures/expected/expected_flat_to_nested_diff.txt")
...
def expected_before_after_diff_file_nested():
    expected_file = os.path.join(TEST_DIR_PATH, "fixtures/expected/expected_nested_to_nested_diff.txt")
    with open(expected_file, "r") as expected_descriptor:
        return expected_descriptor.read()
...
def test_compare_nonempty_files_flat(before_flat_file,
    ...
    assert generate_diff(before_flat_file, after_flat_file, out_format='flat') == expected_before_after_diff_file_flat  # noqa: E501
...
def test_compare_nonempty_files_nested(before_nested_file,
    ...
    assert generate_diff(before_nested_file, after_nested_file, out_format='flat') == expected_before_after_diff_file_nested  # noqa: E501
