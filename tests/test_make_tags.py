...
class TestTagDiffs:
    ...
    expected_before_after_diff_file_flat = "tests/fixtures/expected_before_after_tags_flat.json"  # noqa: E501
    expected_before_after_diff_file_nested = "tests/fixtures/expected_before_after_tags_nested.json"  # noqa: E501

    def test_make_tags_flat(self):
        ...
        # print(make_tags(file_before_data, file_after_data))
        common_data, tags = tag_diffs(file_before_data, file_after_data)
        assert tags == expected_dict

    def test_make_tags_nested(self):
...
if __name__ == "__main__":
    ...
    test.expected_before_after_diff_file_nested = "fixtures/expected_before_after_tags_nested.json"  # noqa: E501
    test.expected_before_after_diff_file_flat = "fixtures/expected_before_after_tags_flat.json"  # noqa: E501

    test.test_make_tags_nested()
